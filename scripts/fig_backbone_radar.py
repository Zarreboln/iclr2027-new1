...
plt.rcParams.update({"font.family":"Comic Sans MS","font.weight":"bold","pdf.fonttype":42,"ps.fonttype":42})
...
SER=[("SALAD",S,"#C0736C","--",1.5),("BoQ",B,"#2F7E96","--",1.5),("CliqueMining",C,"#8A7A3C","--",1.5),("Ours",O,"#C0233A","-",2.4)]
