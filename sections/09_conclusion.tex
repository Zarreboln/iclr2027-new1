...
Training-free: no place labels, and no training set outside the deployment database. \S\ref{sec:method} states the method in full, including every fixed constant. Code, closed-form derivations of $w$, and per-benchmark protocols (splits, GT thresholds, pool sizes) will be released.
