...
Reaching the highest mean across the seventeen benchmarks we report under one fixed configuration, and adopting a stronger backbone by loading it, our approach offers a route to place recognition that needs no place label at any point.
