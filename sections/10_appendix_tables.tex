...
\begin{figure}[H]
\centering
\includegraphics[width=0.46\textwidth]{figures/maxsim_colorbar.pdf}
\caption{Colour key for the six galleries below: line colour is the row maximum $m_i$ of \eqref{eq:stage2}, from weaker (cyan) to stronger (magenta); line width is that patch's contribution $c_i{=}w_i m_i$.}
\label{fig:maxsimkey}
\end{figure}
\begin{figure}[H]
\centering
