...
\section{First stage: the second-order descriptor}
...
\end{table}
\begin{table}[H]
\caption{\textbf{Devices on the second-order descriptor at a matched $1024$-d budget} (compressed before scoring). Bold marks the best value in each column; the weight is the largest device ($18.7$ mean R@1).}
