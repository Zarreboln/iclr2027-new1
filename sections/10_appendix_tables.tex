...
\label{app:protocol}
\begin{table}[H]
\caption{\textbf{Evaluation protocol, per benchmark.} Every method, ours and every baseline, is run through this protocol: same splits, ground truth and database. We do not quote each paper's own number, since those use different ground-truth radii and query subsets.}
\label{tab:protocol}
\centering
