...
The rule of \eqref{eq:stage2}, denoted \textsc{selfw\_conf} in the tables, keeps the matches drawn below; a mutual-match variant is compared against it in \S\ref{app:effo-matched}.
\begin{figure}[H]
\centering
